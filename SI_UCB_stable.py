...
def DGPSI_LCB_stable(max_iters,xlimits,n,d,new_n,m,f,actual_optimum,all_layer_init,N_train,N_predict,label,folder):
    ...
    for iters in range(max_iters):        
        ...
        for i in range(n,n+new_n):
            ...
            model=dgp(x,[y],1000*iters + 2*i,all_layer = all_layer)
            ...
            for bag in range(total_bags):
                ...
                bag_idx = np.random.randint(1,N_predict,size = int(N_predict/2))
