...
def main():
    ...
    for _ in range(3):
        ...
        layer2.append(kernel(length=np.array([1]),name='sexp',nugget_est=True))
    
    # layer3 = [kernel(length=np.array([1]),name='sexp',nugget_est=True,connect = np.arange(d))]
    layer3 = [kernel(length=np.array([1]),name='sexp',nugget_est=True)]
